                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input name="firstName" class="form-control @error('firstName') is-invalid @enderror" id="inputFirstName"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input name="lastName" class="form-control @error('lastName') is-invalid @enderror" id="inputLastName"
